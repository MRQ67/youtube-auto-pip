Error injecting content script: Error: Cannot access contents of url "https://www.youtube.com/watch?v=45fbNFMd_vc". Extension manifest must request permission to access this host.
Context
background.js
Stack Trace
